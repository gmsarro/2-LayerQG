#Computes all terms of the LWA budget but the latent heating contribution
...
max_lenghth= 10000
#Specify the Rossby deformation radius:
Ld=1.
...
read.close()
#2 load reference state PV (Qref), wind (Uref) and temperature (Tref)
...
read.close()
#3 load LWA Cyclonic and Anticyclonic
